...
#Region "Public Functions"
    ...
    Public Sub CreateTables()
        Try
            ...
            AddFields("OITM", "Color", "Color", SAPbobsCOM.BoFieldTypes.db_Alpha, 20)
            AddFields("OITM", "Size", "Size", SAPbobsCOM.BoFieldTypes.db_Alpha, , 10)
            AddFields("OITM", "Style", "Style", SAPbobsCOM.BoFieldTypes.db_Alpha, 50)
            AddFields("OITM", "Type", "Type", SAPbobsCOM.BoFieldTypes.db_Alpha, , 30)
            AddFields("OITM", "Trend", "Trend", SAPbobsCOM.BoFieldTypes.db_Alpha, , 20)
            AddFields("OITM", "Season", "Season", SAPbobsCOM.BoFieldTypes.db_Alpha, , 20)
            AddFields("OITM", "Gender", "Gender", SAPbobsCOM.BoFieldTypes.db_Alpha, , 1)
            AddFields("OITM", "Age_Range", "Age_Range", SAPbobsCOM.BoFieldTypes.db_Alpha, , 20)
            AddFields("OITM", "Year", "Year", SAPbobsCOM.BoFieldTypes.db_Alpha, , 4)
            AddFields("OITM", "CountryOfOrigin", "CountryOfOrigin", SAPbobsCOM.BoFieldTypes.db_Alpha, , 20)
            AddFields("OITM", "ColDes", "Color Description", SAPbobsCOM.BoFieldTypes.db_Alpha, , 50)
