Public Class clsListener
    ...
    Private _Excel As clsExcelClass
...
#Region "Public Properties"
    ...
    Public ReadOnly Property Excel() As clsExcelClass
        Get
            Return _Excel
        End Get
    End Property
...
#Region "Filter"
    ...
    Public Sub SetFilter()
        Try
            ...
            objFilter.AddEx(frm_OPCH) 'Purchase Invoice
        ...
        Try
            ...
            If pVal.BeforeAction = False And pVal.EventType = SAPbouiCOM.BoEventTypes.et_FORM_LOAD Then
                Select Case pVal.FormTypeEx
                    ...
                    Case frm_OPCH
                        If Not _Collection.ContainsKey(FormUID) Then
                            oItemObject = New clsPurchaseInvoices
                            oItemObject.FrmUID = FormUID
                            _Collection.Add(FormUID, oItemObject)
                        End If
                End Select
