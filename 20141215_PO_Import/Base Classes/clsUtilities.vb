...
#End Region
    ...
    Public Function GetExcelData(ByVal oForm As SAPbouiCOM.Form, ByVal strID As String) As Boolean
        ...
        Try
            ...
            _oDt.Columns.Add("Style", GetType(String)).Caption = "U_Style"
            _oDt.Columns.Add("Desc", GetType(String)).Caption = "Description"
            _oDt.Columns.Add("Color", GetType(String)).Caption = "U_Color"
            _oDt.Columns.Add("Size", GetType(String)).Caption = "U_Size"
            _oDt.Columns.Add("BarCode1", GetType(String)).Caption = "BarCode1"
            _oDt.Columns("BarCode1").DefaultValue = ""
            _oDt.Columns.Add("BarCode2", GetType(String)).Caption = "BarCode2"
            _oDt.Columns("BarCode2").DefaultValue = ""
            _oDt.Columns.Add("Quantity", GetType(String)).Caption = "Quantity"
            _oDt.Columns.Add("PO_Currency", GetType(String)).Caption = "Cost_Currency"
            _oDt.Columns.Add("PO_Price", GetType(String)).Caption = "Cost"
            _oDt.Columns("PO_Price").DefaultValue = "0"
            _oDt.Columns.Add("SP_Currency", GetType(String)).Caption = "Sales_Currency"
            ...
            _oDt.Columns.Add("ShipNo", GetType(String)).Caption = "shipment Number"
            _oDt.Columns.Add("Type", GetType(String)).Caption = "U_Type"
            _oDt.Columns.Add("Trend", GetType(String)).Caption = "U_Trend"
            _oDt.Columns.Add("Season", GetType(String)).Caption = "U_Season"
            _oDt.Columns.Add("Gender", GetType(String)).Caption = "U_Gender"
            _oDt.Columns.Add("Age_Range", GetType(String)).Caption = "U_Age_Range"
            _oDt.Columns.Add("Year", GetType(String)).Caption = "U_Year"
            _oDt.Columns.Add("Brand", GetType(String)).Caption = "Brand"
            _oDt.Columns.Add("CountryOfOrigin", GetType(String)).Caption = "U_CountryOfOrigin"
            _oDt.Columns.Add("ColDes", GetType(String)).Caption = "U_ColDes"
            ...
            If strPath.Length > 0 Then
                ...
                For Each txtrow As String In txtRows
                    ...
                    ElseIf intRow > 0 Then
                        fields = txtrow.Split(vbTab)
                        oDr = _oDt.NewRow()
                        oDr.Item(0) = fields(0) ' ParentItemCode
                        oDr.Item(1) = fields(1) ' Style
                        oDr.Item(2) = fields(2) ' Description
                        oDr.Item(3) = fields(3) ' Color
                        oDr.Item(4) = fields(4) ' Size
                        oDr.Item(5) = fields(5) ' BarCode1
                        oDr.Item(6) = fields(6) ' BarCode2
                        oDr.Item(7) = fields(7) ' Quantity
                        oDr.Item(8) = fields(8) ' Cost  Currency

                        If IsDBNull(fields(9)) Or fields(9) = "" Then 'Cost
                            oDr.Item(9) = "0" '    
                        Else
                            oDr.Item(9) = fields(9) '   
                        End If

                        oDr.Item(10) = fields(10) ' SP Currency  

                        If IsDBNull(fields(11)) Or fields(11) = "" Then 'Sales Price
                            oDr.Item(11) = "0" '   
                        Else
                            oDr.Item(11) = fields(11) '   
                        End If

                        oDr.Item(12) = fields(12) ' WareHouse
                        oDr.Item(13) = fields(13) ' PriceList

                        oDr.Item(14) = fields(14) '   Ship No.

                        If strShiping.Length = 0 Then
                            strShiping = fields(14)
                        Else
                            If strShiping <> fields(14) Then
                                Throw New Exception("Multiple Shipping No Exist Please Check the File and Import Again...")
                                Exit Function
                            End If
                        End If

                        oDr.Item(15) = fields(15) '   Type.
                        oDr.Item(16) = fields(16) '   Trend.
                        oDr.Item(17) = fields(17) '   Season.
                        oDr.Item(18) = fields(18) '   Gender.
                        oDr.Item(19) = fields(19) '   Age_Range.
                        oDr.Item(20) = fields(20) '   Year.
                        oDr.Item(21) = fields(21) '   Brand.
                        oDr.Item(22) = fields(22) '   Country of Origin.
                        oDr.Item(23) = fields(23) '   Color Desc
